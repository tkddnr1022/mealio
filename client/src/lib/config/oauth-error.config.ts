...
export const BACKEND_ERROR_CODE_QUERY_PARAMS = ['errorCode', 'error_code'] as const;
export const BACKEND_ERROR_MESSAGE_QUERY_PARAMS = ['errorMessage', 'error_message'] as const;
