...
원칙: **쿼리 캐시가 화면의 SSOT**. API 응답을 `useState`로 복사하지 않습니다.
...
- `agent/frontend/spec/frontend_architecture_spec.md` (§5.3)
- `agent/frontend/guidelines/frontend_development_guidelines.md` (§5)
