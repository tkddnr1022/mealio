...
SSOT: `client/src/lib/policy/cache.policy.ts`
...
SSOT: `client/src/lib/policy/cache.policy.ts` — `QUERY_DEFAULTS`, `QUERY_CACHE`
...
→ `agent/frontend/guidelines/frontend_development_guidelines.md` §5.1
...
- `client/src/lib/policy/cache.policy.ts`
- `agent/frontend/guidelines/frontend_development_guidelines.md` (§2.1, §3)
- `agent/frontend/spec/frontend_architecture_spec.md` (§2)
