...
| 설명 | 챗봇 대화·도구 호출 모델 |
| 예시 | `gpt-4.1-mini` |
| 사용처 | `server/consumer/src/integrations/openai/openai.service.ts` |
...
| 예시 | `gpt-4.1-mini` |
| 사용처 | `server/consumer/src/integrations/openai/openai-batch.service.ts` |
...
| 사용처 | `server/consumer/src/integrations/public-data/public-data-api.client.ts` |
