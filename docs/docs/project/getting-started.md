...
```bash
git clone https://github.com/tkddn1022/mealio.git
cd mealio
...
패키지별 상세 변수는 각 README를 참고하세요.

- `client/README.md`
- `server/producer/README.md`
- `server/consumer/README.md`
...
개발 환경에서는 `compose-producer`·`compose-consumer`·`compose-client`를 **사용하지 않습니다**.
