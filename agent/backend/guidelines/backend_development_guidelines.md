...
**Consumer 필수 환경 변수**: APP_ENV, MONGODB_URL, REDIS_URL, KAFKA_BROKERS, KAFKA_CLIENT_ID, KAFKA_CONSUMER_GROUP_ID, OPENAI_API_KEY, OPENAI_CHAT_MODEL, OPENAI_TITLE_MODEL, OPENAI_QUERY_EXPANSION_MODEL, OPENAI_EMBEDDING_MODEL.
